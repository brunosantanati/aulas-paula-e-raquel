...
class ServicoDeStreaming {
  ...
  public ServicoDeStreaming(
    List<String> series,
    List<String> filmes,
    List<String> documentarios
  ) {
    this.series = series;
    this.filmes = filmes;
...
public class ExercicioAula1 {
  ...
  public static void main(String[] args) {
    ...
    List<String> filmes = List.of(
      "Como eu era antes de voce",
      "O homem do presidente"
    );
    List<String> documentarios = List.of("Vida selvagem", "A vida de hitler");

    ServicoDeStreaming netflix = new ServicoDeStreaming(
      series,
      filmes,
      documentarios
    );
    ServicoDeStreaming amazonPrime = new ServicoDeStreaming(
      series,
      filmes,
      documentarios
    );
